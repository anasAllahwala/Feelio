...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2021 at 11:16 AM
...
--
ALTER TABLE `friend_requests`
  ADD CONSTRAINT `friend_requests_ibfk_1` FOREIGN KEY (`user_a_id`) REFERENCES `users` (`user_id`),
  ADD CONSTRAINT `friend_requests_ibfk_2` FOREIGN KEY (`user_b_id`) REFERENCES `users` (`user_id`);
